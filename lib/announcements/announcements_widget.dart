...
import '../components/announcements_empty_widget.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      logFirebaseEvent(
                          'ANNOUNCEMENTS_ListTile_ltcb74ff_ON_TAP');
                  ...
                  InkWell(
                    onTap: () async {
                      logFirebaseEvent(
                          'ANNOUNCEMENTS_ListTile_8avjuzh0_ON_TAP');
                      logFirebaseEvent('ListTile_navigate_to');
                  ...
                  InkWell(
                    onTap: () async {
                      logFirebaseEvent(
                          'ANNOUNCEMENTS_ListTile_ui93qh3k_ON_TAP');
                      logFirebaseEvent('ListTile_navigate_to');
                  ...
                  InkWell(
                    onTap: () async {
                      logFirebaseEvent(
                          'ANNOUNCEMENTS_ListTile_4cfmyohd_ON_TAP');
                      logFirebaseEvent('ListTile_navigate_to');
                  ...
                  InkWell(
                    onTap: () async {
                      logFirebaseEvent(
                          'ANNOUNCEMENTS_ListTile_nmixe2qq_ON_TAP');
                      logFirebaseEvent('ListTile_navigate_to');
                  ...
                  InkWell(
                    onTap: () async {
                      logFirebaseEvent(
                          'ANNOUNCEMENTS_ListTile_8yegcgh7_ON_TAP');
                  ...
                  InkWell(
                    onTap: () async {
                      logFirebaseEvent(
                          'ANNOUNCEMENTS_ListTile_nchnrdvp_ON_TAP');
                      logFirebaseEvent('ListTile_navigate_to');
              ...
              child: StreamBuilder<List<AnnouncementsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (listViewAnnouncementsRecordList.isEmpty) {
                    return AnnouncementsEmptyWidget();
                  }
                            ...
                            if (listViewAnnouncementsRecord.mediaType ==
                              ...
                              Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: functions.returnImagePath(
                                ...
                                builder: (context) => FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (confirmDialogResponse) {
                                      ...
                                      await listViewAnnouncementsRecord
                                          .reference
                                          .update(announcementsUpdateData);
                                      return;
                                    } else {
