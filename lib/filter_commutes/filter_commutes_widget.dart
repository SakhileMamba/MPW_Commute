...
class FilterCommutesWidget extends StatefulWidget {
  const FilterCommutesWidget({Key? key}) : super(key: key);

  @override
  _FilterCommutesWidgetState createState() => _FilterCommutesWidgetState();
}

class _FilterCommutesWidgetState extends State<FilterCommutesWidget> {
  DateTime? datePicked;
  var placePickerValue1 = FFPlace();
  var placePickerValue2 = FFPlace();
  dynamic? reverseGeocodedDestinationFilter;
  dynamic? reverseGeocodedOriginFilter;
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'filterCommutes'});
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'FILTER_COMMUTES_PAGE_CLEAR_BTN_ON_TAP');
                              ...
                              FFAppState().update(() {
                                ...
                                FFAppState().originFiltered = false;
                              });
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'FILTER_COMMUTES_PAGE_FILTER_BTN_ON_TAP');
                              logFirebaseEvent('Button_custom_action');
                              reverseGeocodedOriginFilter =
                                  await actions.reverseGeocode(
                                placePickerValue1.latLng,
                              );
                              logFirebaseEvent('Button_custom_action');
                              reverseGeocodedDestinationFilter =
                                  await actions.reverseGeocode(
                              ...
                              FFAppState().update(() {
                                FFAppState().filterDepartureDatetime =
                                    datePicked;
                                FFAppState().originFiltered = true;
                              });
                              logFirebaseEvent('Button_navigate_to');
