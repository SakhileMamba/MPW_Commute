...
import 'browse_drivers_empty_model.dart';
export 'browse_drivers_empty_model.dart';
...
class _BrowseDriversEmptyWidgetState extends State<BrowseDriversEmptyWidget> {
  late BrowseDriversEmptyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BrowseDriversEmptyModel());
      ...
      child: Padding(
        ...
        child: Text(
          (FFAppState().filterTempOriginReversed == null) &&
              ...
              ? 'Set the origin, destination and departure datetime filters to start browing drivers.'
              : 'There are no drivers from ${functions.trimCommaEnd('${functions.nullTest(getJsonField(
