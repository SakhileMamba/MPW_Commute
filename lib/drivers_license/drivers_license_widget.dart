                ...
                children: [
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () async {
                        logFirebaseEvent(
                            'DRIVERS_LICENSE_Image_nl2f1ihq_ON_TAP');
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'DRIVERS_LICENSE_PAGE_CANCEL_BTN_ON_TAP');
                                        if (FFAppState()
                                          ...
                                          FFAppState().update(() {
                                            FFAppState().backButtonFileUpload =
                                                false;
                                          });
                                          logFirebaseEvent(
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                ...
                                                content: Text(
                                                    'Your have a license pending verification. Please wait for a response on your current request before attempting to resend.'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
