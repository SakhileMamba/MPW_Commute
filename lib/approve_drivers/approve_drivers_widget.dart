...
class ApproveDriversWidget extends StatefulWidget {
  ...
  @override
  _ApproveDriversWidgetState createState() => _ApproveDriversWidgetState();
}
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'APPROVE_DRIVERS_PAGE_REJECT_BTN_ON_TAP');
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'APPROVE_DRIVERS_PAGE_VERIFY_BTN_ON_TAP');
                                        logFirebaseEvent('Button_alert_dialog');
                                        var confirmDialogResponse =
                                            await showDialog<bool>(
                                                  context: context,
