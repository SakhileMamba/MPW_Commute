...
class AcceptDriversDetailsPageWidget extends StatefulWidget {
  const AcceptDriversDetailsPageWidget({
    Key? key,
    this.hailDoc,
  }) : super(key: key);
  ...
  @override
  _AcceptDriversDetailsPageWidgetState createState() =>
      _AcceptDriversDetailsPageWidgetState();
}

class _AcceptDriversDetailsPageWidgetState
    extends State<AcceptDriversDetailsPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'accept_drivers_details_page'});
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('ACCEPT_DRIVERS_DETAILS_arrow_back_rounde');
                                              ...
                                              Padding(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: InkWell(
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'ACCEPT_DRIVERS_DETAILS_CircleImage_7rf32');
                                                      logFirebaseEvent(
                                                ...
                                                FutureBuilder<VehiclesRecord>(
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    return InkWell(
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'ACCEPT_DRIVERS_DETAILS_Image_6rjpf4cl_ON');
                                                        logFirebaseEvent(
                                                            'Image_Expand-Image');
                                                        await Navigator.push(
                                                          context,
                                                ...
                                                Expanded(
                                                  child: Padding(
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'ACCEPT_DRIVERS_DETAILS_DECLINE_BTN_ON_TA');
                                                        logFirebaseEvent(
                                                    ...
                                                    child: FutureBuilder<
                                                      ...
                                                      builder:
                                                        ...
                                                        return FFButtonWidget(
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'ACCEPT_DRIVERS_DETAILS_ACCEPT_BTN_ON_TAP');
                                                            var _shouldSetState =
                                                                false;
                                                            if (cardUsersRecord
                                                                .verifiedUser!) {
                                                              ...
                                                              triggerPushNotification(
                                                                ...
                                                                initialPageName:
                                                                    'commutes_management_details_page',
                                                                parameterData: {
                                                                  'commuteRef':
                                                                      createdCommute!
                                                                          .reference,
