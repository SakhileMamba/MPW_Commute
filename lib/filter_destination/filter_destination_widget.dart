...
import 'filter_destination_model.dart';
export 'filter_destination_model.dart';

class FilterDestinationWidget extends StatefulWidget {
  const FilterDestinationWidget({Key? key}) : super(key: key);

  @override
  _FilterDestinationWidgetState createState() =>
      _FilterDestinationWidgetState();
}

class _FilterDestinationWidgetState extends State<FilterDestinationWidget> {
  late FilterDestinationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterDestinationModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'filterDestination'});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('FILTER_DESTINATION_arrow_back_rounded_IC');
        ...
        actions: [
          FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('FILTER_DESTINATION_close_rounded_ICN_ON_');
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('FILTER_DESTINATION_PAGE_NEXT_BTN_ON_TAP');
                    ...
                    if (_model.placePickerValue != null) {
                      ...
                      FFAppState().filterTempDestinationReversed =
                          _model.chosenDestinationReversed!;
                      FFAppState().filterTempDestinationLatLng =
                          _model.placePickerValue.latLng;
                      logFirebaseEvent('Button_navigate_to');

                      context.pushNamed('filterDepartureDatetime');
                      ...
                      await showDialog(
                        ...
                        builder: (alertDialogContext) {
                          return AlertDialog(
                            title: Text('Error'),
                            content: Text('Choose your destination'),
                            actions: [
                              TextButton(
                                onPressed: () =>
